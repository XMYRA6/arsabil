      ...
      <div className={styles.mobileHeader}>
        <div className={styles.mobileHeaderRow}>
          <div className={styles.mobileHeaderLogo}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" style={{ color: 'var(--primary)' }}>
              <path d="M12 3L2 12h3v8h14v-8h3L12 3zm0 2.84L17.5 12h-11L12 5.84z" />
            </svg>
            ArsaBil
          </div>
          <button
            className={styles.mobileHeaderSettings}
        ...
        <div className={styles.mobilePageControl}>
          {[0, 1, 2].map(i => (
            <div key={i} className={`${styles.pageDot} ${activeCardIndex === i ? styles.pageDotActive : ''}`} />
          ))}
        </div>
      </div>
