...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      ...
      {/* Removed iOS Glass Page Indicator since we only have 1 main card now */}
          ...
          <div className={`${styles.settingsDrawer} ${isSettingsSidebarOpen ? styles.open : ''}`} onClick={e => e.stopPropagation()}>
            ...
            <div className={styles.drawerContent}>
              ...
              <div className={styles.drawerCard}>
                ...
                <div className={`${styles.drawerRow} ${isApartmentCountEnabled ? styles.column : ''}`}>
                  {!isApartmentCountEnabled ? (
                    <>
                      <div className={styles.drawerRowLabel}>Toplam Daire Sayısı</div>
                ...
                <div className={`${styles.drawerRow} ${isAaEnabled ? styles.column : ''}`}>
                  {!isAaEnabled ? (
                    <>
                      <div className={styles.drawerRowLabel}>Arsa Alanı (m²)</div>
            ...
            <div style={{ overflow: 'hidden', position: 'relative' }}>
              <div style={{
                ...
                <div style={{ minWidth: '100%', padding: '0 16px 16px' }}>
                  <CostBreakdownChart
                    constructionCost={result ? result.Mi : 0}
